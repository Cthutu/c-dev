...
// Assumptions / notes:
// - gfx_init will (on Windows if KORE_OS_WINDOWS defined) optionally create a
//   minimal hidden OpenGL context if none is current, and load only the GL
//   functions required by this module. If a context is already current, it will
//   be used.
